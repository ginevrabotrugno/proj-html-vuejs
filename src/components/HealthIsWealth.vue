        ...
        <div class="row">
            <div class="col">
                <div class="box">
                    ...
                    <div class="d-flex">
                        <div>
                            <h4>All are handmade</h4>
                            <p>If I'm honest, the thing I am proudest of is my varieties of wild flowers in the hay meadow.</p>
                        </div>
                        <div>
                            <h4>100% Fresh ogranic</h4>
                            <p>If I'm honest, the thing I am proudest of is my varieties of wild flowers in the hay meadow.</p>
                        </div>
                    </div>
                    <div>
                ...
                <div>
                    <img src="../assets/image1project.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
